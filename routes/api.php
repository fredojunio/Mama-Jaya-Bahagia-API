...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::post('/transaction/get_completed_transaction_search', [TransactionController::class, 'get_completed_transaction_search']);
    Route::post('/transaction/get_completed_transactions_buku', [TransactionController::class, 'get_completed_transactions_buku']);
    Route::post('/transaction/get_completed_transaction_search_buku', [TransactionController::class, 'get_completed_transaction_search_buku']);
    Route::post('/transaction/get_completed_owner_transactions', [TransactionController::class, 'get_completed_owner_transactions']);
